...
public class ConfigManager {
    ...
    public boolean canSeeAllWorldsFromLobby() {
        return config.getBoolean("spectator-lobby.can-see-all-worlds", true);
    }
    
    public boolean showAllPlayersInTabFromLobby() {
        return config.getBoolean("spectator-lobby.show-all-players-in-tab", true);
    }
    
    public boolean teleportToLobbyOnLeave() {
        return config.getBoolean("spectator-lobby.teleport-to-on-leave", true);
    }
